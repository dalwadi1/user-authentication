...
const Home = () => {
    ...
    const [logedin, chechLogedin] = useState(false)
            ...
            <div className='h-screen w-100 bg-black'>
                <nav className='container mx-auto sticky top-5 flex justify-center'>
                    ...
                    <span className='text-white'>
                        {logedin ? user : <Link to='/sign-in' className='text-orange-500 lg:text-xl md:text-sm xs:text-xs no-underline hover:text-white' style={{ fontFamily: 'Merriweather' }}>Sign <span className='text-white'>in</span></Link>}
                ...
                <div className='text-white h-full -mt-9 w-full flex items-center justify-center '>
                    <div className='flex-col text-center'>
                        ...
                        <button className='bg-orange-500 rounded-full p-1 mt-5 lg:text-lg md:text-sm xs:text-xs'><Link to='/user-desh' className='no-underline text-white flex justify-center items-center' style={{ fontFamily: 'Merriweather' }}>Let's start<FaArrowRightLong className='ml-2' /></Link></button>
                    </div>
                </div>
            </div>
        </>
